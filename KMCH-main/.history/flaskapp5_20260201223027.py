...
def initialize_gemini():
    ...
    # ✅ CORRECTED: Use the exact correct model name
    # Try multiple models in order of preference
    def initialize_gemini():
    gemini = configure_gemini_api()
    # ✅ UPDATED: Use working models only
    model_names = [
        'models/gemini-2.5-flash',        # ✅ Primary - Working
        'models/gemini-2.5-flash-lite',   # ✅ Backup - Working
        'models/gemini-flash-latest',     # ✅ Alternative - Working
        'models/gemma-3-27b-it',          # ✅ Fallback - Working
    ]
